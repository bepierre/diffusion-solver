...
int main(int argc, char *argv[]) {
	...
	system.run();
        ...
        system.write_density("data/density_AVX_mt_N" + std::to_string(N) + "_dt" + std::to_string(dt) + ".dat");
        ...
        std::ofstream out_file("data/conv_AVX_mt_" + std::to_string(Nmin) + "_" + std::to_string(Nmax) + ".dat",
                               std::ios::out);
